...
function Get(path, authorization = authorization_enum_1.Authorization.ROUTE) {
    return function (target, key, descriptor) {
        route_decorator_1.Route(path, authorization, request_method_enum_1.RequestMethod.GET)(target, key, descriptor);
    };
}
exports.Get = Get;
